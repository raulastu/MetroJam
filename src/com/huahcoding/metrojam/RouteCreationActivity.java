 ...
 */
public class RouteCreationActivity extends FragmentActivity implements OnMapLongClickListener{
    /**
...
//        savedInstanceState.putParce(key, value)
    ...
    private void setUpMap() {
         ...
         // Show Lima
         mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(limaLatLng, 10));
         
         mMap.setOnMapLongClickListener(this);
         mMap.setMyLocationEnabled(true);
         mMap.setTrafficEnabled(true);
//        mMap.addMarker(new MarkerOptions().position(limaLatLng).title("Marker"));
    }
